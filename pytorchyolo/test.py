...
from pytorchyolo.utils.augmentations import VOXEL_AUGMENTATION_TRANSFORMS
...
def _evaluate_voxel(model, recon_model, dataloader, class_names, img_size, iou_thres, conf_thres, nms_thres, verbose):
    """Evaluate model on validation dataset.
...
def _create_validation_data_loader_voxel(img_path, batch_size, img_size, sensor_size, num_bins, n_cpu, device):
